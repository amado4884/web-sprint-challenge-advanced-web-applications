...
1. Explain what a token is used for.
   A token is used for authentication. The token not only identifies to the server that the user is logged in, but it also provides a way for the server to know WHICH user is logged in.
2. What steps can you take in your web apps to keep your data secure?
   By using Protected Routes. This ensures users only have access to data they can have access to.
3. Describe how web servers work.
   A server is a program (or collection of programs) that "serve" web pages or data (in the case of JSON) to clients.
